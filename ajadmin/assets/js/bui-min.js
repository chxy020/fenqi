...
function (e) {
    function n(e) {
        return e.replace(/^\s*\/\*[\s\S]*?\*\/\s*$/gm, '').replace(/^\s*\/\/.*$/gm, '')
    }
...
function (e, t, n) {
    ...
    u.prototype._load = function (e, n) {
        function l(e) {
            (e || {
            }).status < o.READY && (e.status = o.READY),
            --a === 0 && n()
        }
    ...
    u._define = function (e, n, i) {
        ...
        if (p) {
            ...
            var m = u._save(p, a);
            f ? (r[f] || {
            }).status === o.FETCHING && (r[f] = m, m.realUri = f)  : h || (h = m)
        } else c = a
    },
...
function (e, t, n) {
    ...
    e.config = function (s) {
        for (var o in s) {
            ...
            } else !u || o !== 'map' && o !== 'preload' ? n[o] = a : (t.isString(a) && (a = [
                a
...
function (e, t, n) {
    ...
    t.forEach(r(), function (t) {
        ...
        t === 'debug' && (e._use = e.use, e._useArgs = [
        ], e.use = function () {
    ...
    var u = BUI.FormHelper = {
        serializeToObject: function (e) {
            ...
            return BUI.each(t, function (e) {
                var t = e.name;
                n[t] ? (BUI.isArray(n[t]) || (n[t] = [
                    n[t]
                ]), n[t].push(e.value))  : n[t] = e.value
            }),
            n
        },
...
define('bui/json', [
    ...
    function n(e, t, n) {
        ...
        switch (e) {
            case 's':
                r = new Date(r.getTime() + 1000 * parseInt(t));
                break;
            case 'n':
                r = new Date(r.getTime() + 60000 * parseInt(t));
                break;
            case 'h':
                r = new Date(r.getTime() + 3600000 * parseInt(t));
                break;
            case 'd':
                r = new Date(r.getTime() + 86400000 * parseInt(t));
                break;
            case 'w':
                r = new Date(r.getTime() + 604800000 * parseInt(t));
                break;
            case 'm':
...
}(), define('bui/component/uibase/base', [
    'bui/component/manage'
], function (e) {
    function u(e, t) {
    ...
    d
}), define('bui/component/uibase/align', [
    'bui/ua'
], function (e) {
    function i(e) {
    ...
    h.prototype = {
        ...
        align: function (e, t, n, i) {
            ...
            if (m && (i.adjustX || i.adjustY)) {
                u(b, g, m) && (v = 1, t = l(t, /[lr]/gi, {
                    l: 'r',
                    r: 'l'
                }), n = c(n, 0)),
                a(b, g, m) && (v = 1, t = l(t, /[tb]/gi, {
                    t: 'b',
                    b: 't'
                }), n = c(n, 1)),
    ...
    t
}), define('bui/component/uibase/keynav', [
    'bui/keycode'
], function (e) {
    var t = e('bui/keycode'),
    n = BUI.wrapBehavior,
    ...
    i.View = t,
    i
}), define('bui/component/uibase/decorate', [
    'bui/array',
    'bui/json',
    'bui/component/manage'
], function (e) {
    ...
    t
}), define('bui/component/uibase/list', [
    'bui/component/uibase/selection'
], function (e) {
    function r(e) {
    ...
    r
}), define('bui/component/controller', [
    'bui/component/uibase',
    'bui/component/manage',
    'bui/component/view',
    ...
    r
}), define('bui/data/treestore', [
    'bui/common',
    'bui/data/node',
    'bui/data/abstractstore',
    'bui/data/proxy'
], function (e) {
    function s(e) {
    ...
    BUI.augment(u, {
        ...
        findIndexBy: function (e, t) {
            ...
            e === null || e === undefined ? - 1 : ($.each(i, function (n, i) {
                if (t(e, i)) return r = n,
                !1
            }), r)
        },
        ...
        remove: function (e, t) {
            ...
            $.each(e, function (e, r) {
                ...
                u = i(e, n.getResult());
                !o(u, n.get('newRecords')) && !o(u, n.get('deletedRecords')) && n.get('deletedRecords').push(u),
    ...
    r = 'x-align-arrow',
    i = n.UIBase,
    s = n.View.extend([i.PositionView,
    i.CloseView]),
    o = n.Controller.extend([i.Position,
    i.Align,
    i.Close,
    i.AutoShow,
    i.AutoHide], {
...
define('bui/list/domlist', [
    ...
    t.augment(a, i, n, {
        ...
        clearItemStatus: function (e, n, r) {
            ...
            r = r || i.findElement(e),
            n ? i.setItemStatus(e, n, !1, r)  : (t.each(s, function (t, n) {
...
define('bui/list/simplelist', [
    ...
    u = t.Component.Controller.extend([r,
    n.Bindable,
    i], {
        bindUI: function () {
            var e = this,
...
define('bui/form/fieldcontainer', [
    'bui/common',
    'bui/form/field',
    'bui/form/groupvalid'
], function (e) {
...
define('bui/form/group/check', [
    ...
    r = t.extend({
        ...
        ATTRS: {
            range: {
                setter: function (e) {
                    if (BUI.isString(e) || BUI.isNumber(e)) e = [
                        parseInt(e)
                    ];
                    return e
                }
...
define('bui/menu/menuitem', [
    ...
    a = 'data-id',
    f = n.View.extend([r.ListItemView,
    r.CollapseableView], {
    ...
    l = n.Controller.extend([r.ListItem,
    r.Collapseable], {
        renderUI: function () {
            var e = this,
            n = e.get('el'),
        ...
        containsElement: function (e) {
            var t = this,
            n,
            r = l.superclass.containsElement.call(t, e);
...
define('bui/tab/navtabitem', [
    ...
    a = n.Controller.extend({
        ...
        ATTRS: {
            ...
            tabContentTpl: {
                view: !0,
                value: '<div class="' + o + '" style="display:none;"><iframe src="" class="iframe_class" name="iframe_name"  width="100%" height="100%" frameborder="0"></iframe></div>'
            },
            href: {
                view: !0,
                value: ''
...
define('bui/toolbar/pagingbar', [
    ...
    p = t.extend([r], {
        ...
        _getItems: function () {
            ...
            ], t.push(e._getButtonItem(s)), t.push(e._getButtonItem(o)), t.push(e._getSeparator()), t.push(e._getTextItem(l)), t.push(e._getTextItem(c)), t.push(e._getButtonItem(f)), t.push(e._getSeparator()), t.push(e._getButtonItem(u)), t.push(e._getButtonItem(a)), t.push(e._getSeparator()), t.push(e._getTextItem(h)), t)
        },
        ...
        _setAllButtonsState: function () {
            var e = this,
            t = e.get('store');
            t && e._setButtonsState([o,
            u,
            s,
            a,
            f], !0),
            e.get('curPage') === 1 && e._setButtonsState([o,
            s], !1),
            e.get('curPage') === e.get('totalPage') && e._setButtonsState([u,
            a], !1)
        },
...
define('bui/toolbar/numberpagingbar', [
    'bui/toolbar/pagingbar'
], function (e) {
    var t = BUI.Component,
    ...
    o = n.extend({
        _getItems: function () {
            ...
            t = e.get('items');
            return t ? t : (t = [
            ], t.push(e._getButtonItem(n.ID_PREV)), t.push(e._getButtonItem(n.ID_NEXT)), t)
        },
        _getButtonItem: function (e) {
            var t = this;
            return {
...
define('bui/calendar/monthpicker', [
    'bui/common',
    'bui/overlay',
    'bui/list',
    'bui/toolbar'
...
define('bui/calendar/datepicker', [
    'bui/common',
    'bui/picker',
    'bui/calendar/calendar'
], function (e) {
...
define('bui/grid/format', function (e) {
    ...
    var n = {
        ...
        moneyCentRenderer: function (e) {
            ...
            $.isNumberic(e) ? (e * 0.01).toFixed(2)  : e
        }
    };
    return n
}),
...
define('bui/grid/plugins/selection', [
    'bui/common'
], function (e) {
    function o(e) {
...
define('bui/grid/plugins/summary', [
    'bui/common'
], function (e) {
    function l(e) {
...
define('bui/grid/plugins/editing', function (e) {
    ...
    BUI.augment(r, {
        ...
        showRecordError: function (e, t, n) {
            ...
            i = r.get('grid');
            n = n || i.findRow(e),
            n && (r._clearRowError(n), BUI.each(t, function (e) {
...
define('bui/grid/plugins/cellediting', [
...
define('bui/grid/plugins/rowediting', [
    'bui/common',
    'bui/grid/plugins/editing'
], function (e) {
    var t = e('bui/common'),
...
define('bui/grid/plugins/dialogediting', [
    'bui/common'
], function (e) {
    function i(e) {
        i.superclass.constructor.call(this, e)
...
define('bui/tree/treemixin', [
    ...
    n.augment(w, {
        ...
        _initRoot: function () {
            ...
            i = e.get('showRoot'),
            s;
            t && (r = t.get('root'), e.setInternal('root', r), i ? s = [
                r
            ] : s = r.children, n.each(s, function (t) {
                e._initChecked(t, !0)
        ...
        _initChecked: function (e, t) {
            ...
            t && n.each(e.children, function (e) {
                r._initChecked(e, t)
            })
        },
        ...
        _beforeLoadNode: function (e) {
            ...
            e && n.each(e.children, function (e) {
                t._removeNode(e)
            })
        },
        onBeforeLoad: function (e) {
...
define('bui/tooltip/tip', [
    'bui/common',
    'bui/overlay'
], function (e) {
    function s(e, t) {
        if (e === 'left') return [ - 1 * t,
        - 4];
        if (e === 'right') return [t,
        - 4];
        if (e.indexOf('top')) return [0,
        t];
        if (e.indexOf('bottom')) return [0,
        - 1 * t]
    }
    var t = e('bui/common'),
    n = e('bui/overlay'),
