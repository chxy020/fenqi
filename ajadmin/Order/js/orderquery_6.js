...
$(function(){
	...
	$("#querybtn_6").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100510;//查询待财务审核100510
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_6").val() || "";
		condi.applicantPhone = $("#applicantPhone_6").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_6").val() || ""
