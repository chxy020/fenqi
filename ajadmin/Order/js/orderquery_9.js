...
$(function(){
	...
	$("#querybtn_9").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100503;//查询风控审核中100503
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_9").val() || "";
		condi.applicantPhone = $("#applicantPhone_9").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_9").val() || ""
