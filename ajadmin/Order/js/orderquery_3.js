...
$(function(){
	...
	$("#querybtn_3").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100507;//查询还款中100507
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_3").val() || "";
		condi.applicantPhone = $("#applicantPhone_3").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_3").val() || ""
