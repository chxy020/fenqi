...
$(function(){
	...
	$("#querybtn_1").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100505;//查询待缴手续费100505
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_1").val() || "";
		condi.applicantPhone = $("#applicantPhone_1").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_1").val() || ""
