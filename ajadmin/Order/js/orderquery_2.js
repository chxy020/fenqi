...
$(function(){
	...
	$("#querybtn_2").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100506;//查询待支付100506
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_2").val() || "";
		condi.applicantPhone = $("#applicantPhone_2").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_2").val() || ""
