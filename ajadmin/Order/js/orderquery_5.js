...
$(function(){
	...
	$("#querybtn_5").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100509;//查询审核不通过100509
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_5").val() || "";
		condi.applicantPhone = $("#applicantPhone_5").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_5").val() || ""
