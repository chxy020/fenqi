...
$(function(){
	...
	$("#querybtn_7").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100501;//查询订单未完成100501
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_7").val() || "";
		condi.applicantPhone = $("#applicantPhone_7").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_7").val() || ""
