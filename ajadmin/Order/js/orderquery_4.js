...
$(function(){
	...
	$("#querybtn_4").bind("click",queryOrderList);
	...
	*/
	...
	function sendQueryOrderListHttp(){
		...
		condi.status = 100508;//查询已还清100508
		condi.currentPageNum = g.currentPage;
		condi.applicantName = $("#applicantName_4").val() || "";
		condi.applicantPhone = $("#applicantPhone_4").val() || "";
		condi.createTimeBegin = $("#createTimeBegin").val() || "";
		condi.createTimeEnd = $("#createTimeEnd").val() || "";
		condi.orderId = $("#orderId_4").val() || ""
