...
MagicZoom.prototype.showrect = function () {
	...
	/* 1-11 */this.bigImageCont.style.top = "-383px";
...
MagicZoom.prototype.hiderect = function () {//MagicZoom.prototype.hiderect = function () {
...
MagicZoom.prototype.initZoom = function () {
    ...
    this.bigImageCont.style.top = '-383px';//this.bigImageCont.style.top = '-10000px';
	...
	/* 1-11 */this.bigImageCont.style.left = "auto";
    if (this.pup) {
        this.recalculatePopupDimensions();
        return
}
...
aels[i].style.display = 'inline-block';
aels[i].style.outline = '0';
...
bigCont.style.visibility = 'visible';//bigCont.style.visibility = 'hidden';
if (position != 'custom') {
...
getStyle: function (el, style) {
    ...
    if ('opacity' == style) return val ? parseFloat(val)  : 1;
...
'opacity': [
0,
MagicThumb.options.backgroundFadingOpacity
]
})
},
...
var effectProps = {
'opacity': [
(this.options.keepThumbnail) ? 0 : 1,
1
],
'top': [
this.bigImg.initTop,
